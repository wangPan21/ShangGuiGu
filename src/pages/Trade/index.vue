  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        <p @click="ischangeAddress(address, addressInfo)">
...
export default {
  ...
  // 修改默认地址
  methods: {
    ischangeAddress(address, addressInfo) {
      //排他思想
  ...
  computed: {
    ...mapState({
      addressInfo: (start) => start.Trade.address,
      orderInfo: (start) => start.Trade.orderInfo,
    }),
    //修改提交订单的默认地址
    userDefaultAddress() {
      //find：查找数组当中符合条件的元素，返回
